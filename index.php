        ...
        <div class="container-fluid">
            ...
            <section class="col-12">
                <div class="row">
                    <!--MOVIE-->
                    <article class="col-4">
                        <img class="mt-5 rounded-5 mx-3 marginneg " width="550px" height="550px" src="./assets/image/covers/<?= $picturePaths[19] ?>" >
                    </article>
                    <!--Movie section 1-->
            ...
            <section class="col-12">
                ...
                <div class="col-4">
                    <div class="row">
                        ...
                        <img class="mt-5 rounded-5 mx-3 marginneg " width="550px" height="550px" src="./assets/image/covers/<?= $picturePaths[20] ?>" >
                        </article>
                    </div>
                </div>
             </section>
        ...
        <div class="container-fluid">
            ...
            <section class="col-12">
                <div class="row">
                    <!--GAMING-->
                    <article class="col-4">
                    <img class="mt-5 rounded-5 mx-3 marginneg " width="550px" height="550px" src="./assets/image/covers/<?= $picturePaths[21] ?>" >
                    </article>
                    <div class="col-8">
                        <div class="row">
                            <!--Gaming section 1-->
            ...
            <section class="col-12">
               ...
               <div class="col-sm-8">
                ...
                <div class="col-4">
                    <div class="row">
                        <article class="col-12">
                        <img class="mt-5 rounded-5 mx-3 marginneg " width="550px" height="550px" src="./assets/image/covers/<?= $picturePaths[22] ?>" >
                        </article>
                    </div>
                </div>
             </section>
        ...
        <div class="container-fluid">
            ...
            <section class="col-12">
                <div class="row">
                    <!--BOOK-->
                    <article class="col-4">
                    <img class="mt-5 rounded-5 mx-3 marginneg " width="550px" height="550px" src="./assets/image/covers/<?= $picturePaths[23] ?>" >
                    </article>
                    <div class="col-8">
                        <div class="row">
                            <!--Book section 1-->
        ...
        <div class="container-fluid">
            ...
            <section class="col-12">
                ...
                <div class="col-4">
                    <div class="row">
                        <article class="col-12">
                        <img class="mt-5 rounded-5 mx-3 marginneg " width="550px" height="550px" src="./assets/image/covers/<?= $picturePaths[24] ?>" >
                        </article>
                    </div>
                </div>
             </section>
